...
export default function Header() {
  ...
  const logoutMutantion = useMutation({
  ...
  //khi chúng ta chuyển trang header chỉ bị re-render chứ không bị unmount- mounting again
    ...
    <div className='bg-[linear-gradient(-180deg,#f53d2d,#f63)] pb-5 pt-2 text-white'>
      <div className='mx-auto max-w-7xl px-4'>
          ...
          {isAuthenticated && (
            ...
            >
              <div className='mr-2 h-5 w-5 flex-shrink-0'>
                <img
                  src='https://tse1.mm.bing.net/th?id=OIP.sQITeQsafh6osAKTB25AMgHaFj&pid=Api&P=0'
                  alt='avatar'
        ...
        <div className='mt-4 grid grid-cols-12 items-end gap-4'>
          ...
          <form className='col-span-9' onSubmit={onSubmitSearch}>
            <div className='flex rounded-sm bg-white p-1'>
              <input
                ...
                {...register('name')}
              />
              <button className='flex-shirnk-0 rounded-sm bg-orange py-2 px-6 hover:opacity-90'>
                <svg
                  xmlns='http://www.w3.org/2000/svg'
                  fill='none'
                  viewBox='0 0 24 24'
          ...
          <div className='col-span-1 justify-self-center  hover:text-white/70'>
            <Popover
              // initialOpen
              renderPopover={
                <div className='relative max-w-[400px] rounded-sm border border-gray-200 bg-white text-sm shadow-md'>
                  {purchaseInCart ? (
                    <div className='p-2'>
                      ...
                      <div className='mt-6 flex items-center justify-between'>
                        <div className='text-xs capitalize text-gray-500'>
                          {purchaseInCart.length > MAX_PURCHASES ? purchaseInCart.length - MAX_PURCHASES : ''}
                          {''} Thêm hàng vào giỏ
                        </div>
                    ...
                    <div className='flex h-[300px] w-[300px] flex-col items-center justify-center p-2'>
                      ...
                      <div className='mt-3 font-bold capitalize text-orange'>Chưa có sản phẩm</div>
                    </div>
                  )}
                </div>
              }
            >
              <Link to='/' className='relative'>
                ...
                {purchaseInCart && (
                  <span className='absolute top-[-5px] left-[17px] rounded-full bg-white px-[9px] py-[1px] text-xs font-bold text-orange'>
