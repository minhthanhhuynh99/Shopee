    ...
    <div className='bg-gray-200 py-6'>
            ...
            <div className='col-span-7'>
              ...
              <div className='mt-8 flex items-center'>
                ...
                <div>
                  ...
                  <span className='ml-1 text-gray-500'>Đã vào xem</span>
                </div>
              </div>
              <div className='mt-8 flex items-center bg-gray-50 px-5 py-4'>
                <div className='text-gray-500 line-through'>₫{formatCurrency(product.price_before_discount)}</div>
                <div className='ml-3 text-3xl font-medium text-orange'>₫{formatCurrency(product.price)}</div>
                <div className='ml-4 rounded-sm bg-orange px-1 py-[2px] text-xl font-semibold uppercase text-white'>
              ...
              <div className='mt-8 flex items-center'>
                ...
                <button className='rouded-sm ml-4 flex h-12 min-w-[5rem] items-center justify-center bg-orange px-5 capitalize text-white shadow-sm outline-none hover:bg-orange/90'>
                  Mua ngay
                </button>
              </div>
            </div>
      ...
      <div className='mt-8'>
        <div className='mx-auto max-w-7xl px-4'>
          ...
          {productsData && (
            <div className='lg:grid-col-5 mt-6 grid grid-cols-2 gap-3 md:grid-cols-4 xl:grid-cols-6'>
