...
import { sortBy, order as orderContain } from 'src/contants/product'
      ...
      <div className='flex flex-wrap items-center justify-between gap-2'>
        <div className='flex flex-wrap items-center gap-2'>
          ...
          >
            ...
            <option value={orderContain.asc} className='bg-white text-black'>
              Giá: Thấp đến cao
            </option>
            <option value={orderContain.desc} className='bg-white text-black'>
              Giá: Cao đến Thấp
            </option>
          </select>
        </div>
